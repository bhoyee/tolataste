                            ...
                            <tbody>
                                @foreach ($categories as $index => $category)
                                    <tr>
                                        ...
                                        <td>
                                          @forelse ($languages as $language)
                                            <a href="{{ route('admin.translation.category.create', [
                                            'code' => $language->code,
                                            'id' => $category->id
                                          ]) }}"><i class="fa {{ $category?->translation($language->code)->first()?->name ? 'fa-check' : 'fa-edit' }}"></i></a>
                                            @if(!$loop->last)
                                              | 
                                            @endif
                                          @empty
                                          <a href="{{ route('admin.translation.category.create', [
                                            'code' => app()->getLocale(),
                                            'id' => $category->id
                                          ]) }}"><i class="fa {{ $category?->translation(app()->getLocale())->first()?->name ? 'fa-check' : 'fa-edit' }}"></i></a>
                                          @endforelse
                                        </td>
                                        <td>
