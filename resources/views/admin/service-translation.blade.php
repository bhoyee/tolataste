...
@section('title')
<title>{{__('admin.Edit Service')}} ({{ strtoupper(request('code')) }})</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Edit Service')}} ({{ strtoupper(request('code')) }})</h1>
          ...
          <div class="section-body">
            ...
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.translation.service.update', ["code" => request('code'), "id" => request('id')]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
