                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="today_orders">
                          {{ $today_orders->count() }}
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="today_total_earning">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="monthly_orders">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="monthly_total_earning">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="yearly_orders">
                          {{ $yearly_orders->count() }}
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="yearly_total_earning">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="total_admin">
                          {{ $total_admin }}
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                      ...
                      <div class="card-wrap">
                        ...
                        <div class="card-body" id="total_subscriber">
                          {{ $total_subscriber }}
                        </div>
                      </div>
                    </div>
                            ...
                            @foreach ($today_orders->where('order_status',0) as $index => $order)
                                <tr>
                                    <td>{{ ++$index }}</td>
                                      ...
                                      @elseif($order->guest)
                                          <span class="text-muted">{{ $order->guest->name }} (Guest)</span>
                                      @else
                                    ...
                                    <a href="{{ route('admin.order-show',$order->id) }}" class="btn btn-primary btn-sm" title="View Details"><i class="fa fa-eye" aria-hidden="true"></i></a>

                                    <a href="javascript:;" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger btn-sm" onclick="deleteData({{ $order->id }})" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>

                                    <a href="javascript:;" data-toggle="modal" data-target="#orderModalId-{{ $order->id }}" class="btn btn-warning btn-sm" title="Change Status"><i class="fas fa-truck" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                              @endforeach
                        </tbody>
...
async function refreshDashboardStats() {
    try {
        ...
        updateStat('today_orders', data.today_orders);
        updateStat('today_total_earning', '{{ $currency_icon }}' + data.today_total_earning);
        updateStat('monthly_orders', data.monthly_orders);
        updateStat('monthly_total_earning', '{{ $currency_icon }}' + data.monthly_total_earning);
        updateStat('yearly_orders', data.yearly_orders);
        updateStat('yearly_total_earning', '{{ $currency_icon }}' + data.yearly_total_earning);
        updateStat('total_orders', data.total_orders);
        updateStat('total_earning', '{{ $currency_icon }}' + data.total_earning);
        updateStat('total_users', data.total_users);
        updateStat('total_admin', data.total_admin);
        updateStat('total_subscriber', data.total_subscriber);
    } catch (err) {
...
async function refreshTodayOrders() {
    try {
        const res = await fetch("{{ route('admin.dashboard.today_orders_html') }}");
        const data = await res.json();

        document.getElementById("today_orders_rows").innerHTML = data.tableRows;
        document.getElementById("orderModalsContainer").innerHTML = data.modals;
    } catch (err) {
