                        ...
                        <table class="table table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th width="5%">{{__('admin.Quantity')}}</th>
                                    <th width="5%">{{__('admin.Amount')}}</th>
                                    <th width="8%">{{__('admin.Pre-Order')}}</th>
                                    <th width="8%">{{__('admin.Order Type')}}</th>
                                ...
                                @foreach ($orders as $index => $order)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($order->guest)
                                                <span class="text-info">{{ $order->guest->name }} <small class="text-muted">(Guest)</small></span>
                                            @else
                                                <span class="text-danger">No Customer Info</span>
                                            @endif
                                        </td>
