                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          @forelse ($languages as $language)
                                            <a href="{{ route('admin.translation.custom-page.create', ['code' => $language->code, 'id' => $customPage->id]) }}"><i class="fa {{ $customPage->translation($language->code)?->first()?->page_name ? 'fa-check' : 'fa-edit' }}"></i>
                                                {{ strtoupper($language->code) }}</a>
                                            @if(!$loop->last)
                                            |
                                            @endif
                                            @empty
                                            <a href="{{ route('admin.translation.custom-page.create', [
                                          'code' => app()->getLocale(), 'id' => $customPage->id
                                      ]) }}"><i class="fa {{ $customPage->translation(app()->getLocale())->first()?->page_name ? 'fa-check' : 'fa-edit' }}"></i>
