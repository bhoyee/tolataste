...
@if (!empty($admin) && !empty($admin->image))
  <img src="{{ asset($admin->image) }}" class="rounded-circle profile-widget-picture" alt="Admin Photo">
@else
  <img src="{{ asset(optional($defaultProfile)->image ?? 'uploads/website-images/default-avatar.png') }}" class="rounded-circle profile-widget-picture" alt="Default Photo">
@endif
