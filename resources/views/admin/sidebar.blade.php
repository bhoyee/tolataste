...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.translation.product.*') || Route::is('admin.translation.product-category.*') || Route::is('admin.product.*') || Route::is('admin.product-variant') || Route::is('admin.product-gallery') || Route::is('admin.product-review') || Route::is('admin.show-product-review') || Route::is('admin.product-category.*') || Route::is('admin.reservation') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ (Route::is('admin.product.*') || Route::is('admin.translation.product.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product.index') }}">{{__('admin.Products')}}</a></li>

                <li class="{{ (Route::is('admin.product-category.*') || Route::is('admin.translation.product-category.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product-category.index') }}">{{__('admin.Categories')}}</a></li>
                ...
                <li class="{{ Route::is('admin.catering.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.catering.index') }}"> <span>Catering Requests</span> </a></li>
                               <li class="{{ Route::is('admin.delivery-setting.*') ? 'active' : '' }}">
                  <a class="nav-link" href="{{ route('admin.delivery-setting.edit', 1) }}">
          ...
          <!--<li class="nav-item dropdown {{ Route::is('admin.translation.settings.app.*') || Route::is('admin.translation.service.*') || Route::is('admin.service.*') || Route::is('admin.slider.*') || Route::is('admin.counter.*') || Route::is('admin.translation.counter.*') || Route::is('admin.app-section') || Route::is('admin.partner.*') ? 'active' : '' }}">-->
          <!--  <a href="#" class="nav-link has-dropdown"><i class="fas fa-shopping-cart"></i><span>{{__('admin.Section')}}</span></a>-->
          <!--  <ul class="dropdown-menu">-->

          <!--      <li class="{{ (Route::is('admin.service.*') || Route::is('admin.translation.service.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.service.index') }}">{{__('admin.Service')}}</a></li>-->

          <!--      <li class="{{ Route::is('admin.slider.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider.index') }}">{{__('admin.Slider')}}</a></li>-->

          <!--      <li class="{{ (Route::is('admin.counter.*') || Route::is('admin.translation.counter.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.counter.index') }}">{{__('admin.Counter')}}</a></li>-->

          <!--      <li class="{{ Route::is('admin.partner.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.partner.index') }}">{{__('admin.Partner')}}</a></li>-->

          <!--      <li class="{{ (Route::is('admin.app-section') || Route::is('admin.translation.settings.app.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.app-section') }}">{{__('admin.App Section')}}</a></li>-->
          ...
          <li class="nav-item dropdown {{ Route::is('admin.footer.*') || Route::is('admin.translation.footer.*') || Route::is('admin.social-link.*') || Route::is('admin.footer-link.*') || Route::is('admin.second-col-footer-link') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('admin.Header and Footer')}}</span></a>
            <ul class="dropdown-menu">

                <li class="{{ (Route::is('admin.footer.*') || Route::is('admin.translation.footer.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.footer.index') }}">{{__('admin.Footer')}}</a></li>

                <li class="{{ Route::is('admin.social-link.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.social-link.index') }}">{{__('admin.Social Link')}}</a></li>
            </ul>
          </li>

          <li class="nav-item dropdown {{ Route::is('admin.translation.custom-page.*') || Route::is('admin.translation.about-us.*') || Route::is('admin.translation.our-chef.*') || Route::is('admin.translation.terms-and-condition.*') || Route::is('admin.translation.privacy-policy.*') || Route::is('admin.testimonial.*') || Route::is('admin.translation.testimonial.*') || Route::is('admin.about-us.*') || Route::is('admin.custom-page.*') || Route::is('admin.terms-and-condition.*') || Route::is('admin.privacy-policy.*') || Route::is('admin.faq.*') || Route::is('admin.error-page.*') || Route::is('admin.contact-us.*') || Route::is('admin.login-page') || Route::is('admin.our-chef.*') || Route::is('admin.translation.faq.*') || Route::is('admin.homepage') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ (Route::is('admin.about-us.*') || Route::is('admin.translation.about-us.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.about-us.index') }}">{{__('admin.About Us')}}</a></li>

                <li class="{{ Route::is('admin.contact-us.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.contact-us.index') }}">{{__('admin.Contact Us')}}</a></li>

                <!--<li class="{{ (Route::is('admin.testimonial.*') || Route::is('admin.translation.testimonial.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.testimonial.index') }}">{{__('admin.Testimonial')}}</a></li>-->

                <!--<li class="{{ (Route::is('admin.our-chef.*') || Route::is('admin.translation.our-chef.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.our-chef.index') }}">{{__('admin.Our Chef')}}</a></li>-->

                <!--<li class="{{ (Route::is('admin.custom-page.*') || Route::is('admin.translation.custom-page.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.custom-page.index') }}">{{__('admin.Custom Page')}}</a></li>-->

                <li class="{{ (Route::is('admin.terms-and-condition.*') || Route::is('admin.translation.terms-and-condition.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.terms-and-condition.index') }}">{{__('admin.Terms And Conditions')}}</a></li>

                <li class="{{ (Route::is('admin.privacy-policy.*') || Route::is('admin.translation.privacy-policy.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.privacy-policy.index') }}">{{__('admin.Privacy Policy')}}</a></li>

                <li class="{{ (Route::is('admin.faq.*') || Route::is('admin.translation.faq.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.faq.index') }}">{{__('admin.FAQ')}}</a></li>
                <li class="{{ Route::is('admin.gallery.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.gallery.index') }}"><span>Manage Gallery</span> </a>


                <!--<li class="{{ Route::is('admin.error-page.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.error-page.index') }}">{{__('admin.Error Page')}}</a></li>-->

                <!--<li class="{{ Route::is('admin.login-page') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.login-page') }}">{{__('admin.Login / Register Page')}}</a></li>-->

            </ul>
          </li>

          <!--<li class="nav-item dropdown {{ Route::is('admin.translation.blog.*') || Route::is('admin.translation.category.*') || Route::is('admin.blog-category.*') || Route::is('admin.blog.*') || Route::is('admin.popular-blog.*') || Route::is('admin.blog-comment.*') ? 'active' : '' }}">-->
          <!--  <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('admin.Blogs')}}</span></a>-->
          <!--  <ul class="dropdown-menu">-->

          <!--      <li class="{{ (Route::is('admin.blog-category.*') || Route::is('admin.translation.category.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.blog-category.index') }}">{{__('admin.Categories')}}</a></li>-->

          <!--      <li class="{{ (Route::is('admin.blog.*') || Route::is('admin.translation.blog.*')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.blog.index') }}">{{__('admin.Blogs')}}</a></li>-->
          ...
          <!--<li class="{{ (Route::is('admin.languages.*') || Route::is('admin.admin-language') || Route::is('admin.admin-validation-language') || Route::is('admin.website-language') || Route::is('admin.website-validation-language')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.languages.index') }}"><i class="fas fa-language"></i>{{__('admin.Manage Language')}}</a></li>-->
...
<!--          <li class="{{ Route::is('admin.catering.*') ? 'active' : '' }}">-->
<!--  <a class="nav-link" href="{{ route('admin.catering.index') }}">-->
<!--    <i class="fas fa-utensils"></i> <span>Catering Requests</span>-->
<!--  </a>-->
<!--</li>-->
